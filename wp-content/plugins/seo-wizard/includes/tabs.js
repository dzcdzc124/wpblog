function WSW_init_tabs()
{
	/* if this is not an SEO Wizard admin page, quit */
	...
	jQuery('#su-tabset ul a').click(function(i){
		WSW_hash_form(jQuery(this).attr('href'));
	});
}
