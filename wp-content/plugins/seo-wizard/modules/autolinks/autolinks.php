...
class WSW_Autolinks extends SEO_Module {
	static function get_module_title() { return __('Deeplink Juggernaut', 'seo-wizard'); }
    function get_menu_title() { return __('Deeplink Juggernaut', 'seo-wizard'); }
	
	function add_help_tabs($screen) {
		
		$screen->add_help_tab(array(
			  'id' => 'su-autolinks-overview'
			, 'title' => __('Overview', 'seo-wizard')
			, 'content' => __("
<ul>
...
", 'seo-wizard')));
		...
		$screen->add_help_tab(array(
			...
			, 'title' => __('Content Links Tab', 'seo-wizard')
			, 'content' => __("
...
", 'seo-wizard')));
		...
		$screen->add_help_tab(array(
			...
			, 'title' => __('Content Link Settings Tab', 'seo-wizard')
			, 'content' => __("
...
", 'seo-wizard')));
		...
		$screen->add_help_tab(array(
			...
			, 'title' => __('Footer Links Tab', 'seo-wizard')
			, 'content' => __("
...
", 'seo-wizard')));
		...
		$screen->add_help_tab(array(
			...
			, 'title' => __('Footer Link Settings Tab', 'seo-wizard')
			, 'content' => __("
...
<ul>
	...
	<li><strong>Does Deeplink Juggernaut edit my posts&#8217; content as it is stored in the database?</strong><br />No. Autolinks are added dynamically. This means all the autolinks will go away if you disable Deeplink Juggernaut or deactivate SEO Wizard.</li>
