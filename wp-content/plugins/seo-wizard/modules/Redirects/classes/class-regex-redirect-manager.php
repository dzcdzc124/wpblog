...
if ( class_exists( 'WSW_Redirect_Manager' ) && ! class_exists( 'WSW_REGEX_Redirect_Manager', false ) ) {

	class WSW_REGEX_Redirect_Manager extends WSW_Redirect_Manager {

		protected $option_redirects = 'seo-wizard-redirects-regex';
