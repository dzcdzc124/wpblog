...
class WSW_Redirect_File_Manager {
	...
	public static function get_dir() {
		...
		return $wp_upload_dir['basedir'] . '/seo_wizard-redirects';
	}
	...
	public static function create_upload_dir() {
		...
		if ( ! file_exists( self::get_dir() . '/index.php' ) ) {
			@file_put_contents( self::get_dir() . '/index.php', '<?php' . PHP_EOL  );
		}
	...
	public static function get_wp_filesystem_object() {
		...
		$url = wp_nonce_url( 'admin.php?page=wsw_redirects#top#settings', 'update-htaccess' );
