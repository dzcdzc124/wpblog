...
if ( class_exists( 'WSW_Redirect_Manager' ) && ! class_exists( 'WSW_URL_Redirect_Manager', false ) ) {

	class WSW_URL_Redirect_Manager extends WSW_Redirect_Manager {

		protected $redirects;

		protected $option_redirects = 'seo-wizard-redirects';
		...
		private function do_redirect( $url, $redirect_url ) {
			if ( 410 !== $this->redirects[ $url ]['type'] ) {
				header( 'X-Redirect-By: Seo-Wizard' );
